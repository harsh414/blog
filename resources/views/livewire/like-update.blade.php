<div class="border-r border-gray-100 px-5 py-4 flex flex-col items-center sm:py-4 md:py-12 text-center bg-gray-300 md:w-1/6"> <!-- votes container-->
    ...
    <div class="mt-3 sm:mt-3 md:mt-8">
        @if($blog->ifLikedBy(auth()->user(), $blog))
            <button wire:click="likeUpdate" class="text-center text-gray-600 bg-blue transition ease-in  px-5 py-2 focus:outline-none rounded-xl font-semibold">
                Clapped
            </button>
        @else
